...
const AddReviewForm = ({serviceId}) => {
    ...
    const handleAddReview = e => {
        ...
        const reviewInfo = {userName, userEmail, userPhotoURL, userReview, ratings, serviceId};
         ...
         <div className="mx-4 md:ml-10 bg-[#1D2A35] px-6 pt-8 pb-20">
            ...
            <form onSubmit={handleAddReview} className="grid grid-cols-2 my-6">
              ...
              <input
                ...
                readOnly
              />
            <button className="btn btn-info hover:bg-blue-700 hover:text-white w-full" title="click submit to add review">
              Add Review
            </button>
            </form>
          </div>   
